        ...
        <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;"> 
                       <a href="" class="site_title" style="font-size:15px !important; font-weight:bold">Shastho Shikkha Foundation</a>
                    </div>
            ...
            <div class="right_col" role="main">
                ...
                <footer>
                    <div class="">
                        <p class="pull-right">
                            <span class="lead"><span class="lead">&copy;  2017 SSF(Shastho Shikkha Foundation)</span></span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer>
