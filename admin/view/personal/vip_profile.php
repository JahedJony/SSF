...
<div class="x_content">
	<div class="x_panel employee_profile">
		...
		<div class="x_content" id="iniial_collapse">
			<br />     
			<form method="emp"  id="vip_update_form" name="vip_info_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
				<div class="row">
					<div class="col-md-9">	
						...
						<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-6">
								<input type="text" id="vip_name" name="vip_name" required class="form-control col-lg-12" readonly="readonly"/>
							</div>	
						...
						<div class="form-group">
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								<button  type="submit" id="save_vip_info" class="btn btn-success">Update</button>                                        
							</div>
					...
					<div class="col-md-3">
						...
						<img src="" class="img-thumbnail" id="vip_img">
					</div>
				</div>
			</form> 
		</div>
...
$(document).ready(function () {	
	...
	load_vip_profile = function load_vip_profile(){
		...
		$.ajax({
			...
			data: {
				q: "get_vip_info",
				vip_id: "<?php echo $_SESSION['user_id']; ?>"
			},
			success: function(data){
				$('#vip_id').val(data.records.id);
				$('#vip_name').val(data.records.name);
				...
				$('#vip_img').attr("src",project_url+data.records.image);
	...
	$('#save_vip_info').click(function(event){		
		...
		var formData = new FormData($('#vip_update_form')[0]);
