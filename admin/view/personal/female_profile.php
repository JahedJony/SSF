...
<div class="x_content">
	<div class="x_panel employee_profile">
		...
		<div class="x_content" id="iniial_collapse">
			<br />     
			<form method="emp"  id="female_update_form" name="female_info_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
				<div class="row">
					<div class="col-md-9">	
						...
						<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-6">
								<input type="text" id="female_name" name="female_name" required class="form-control col-lg-12" readonly="readonly"/>
							</div>	
						...
						<div class="form-group">
                        	<label class="control-label col-md-2 col-sm-2 col-xs-6">Institute Name </label>
							<div class="col-md-4 col-sm-4 col-xs-6">
						...
						<div class="form-group">
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								<button  type="submit" id="save_female_info" class="btn btn-success">Update</button>                                        
							</div>
					...
					<div class="col-md-3">
						...
						<img src="" class="img-thumbnail" id="female_img">
					</div>
				</div>
			</form> 
		</div>
...
$(document).ready(function () {	
	...
	load_female_profile = function load_female_profile(){
		...
		$.ajax({
			...
			data: {
				q: "get_female_info",
				female_id: "<?php echo $_SESSION['user_id']; ?>"
			},
			success: function(data){
				$('#female_id').val(data.records.id);
				$('#female_name').val(data.records.name);
				...
				$('#female_img').attr("src",project_url+data.records.image);
	...
	$('#save_female_info').click(function(event){		
		...
		var formData = new FormData($('#female_update_form')[0]);
