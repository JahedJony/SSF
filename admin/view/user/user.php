        ...
        <table id="emp_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
            <thead >
                <tr class="headings">
                    ...
                    <th class="column-title" width="15%">Health Card</th>
		...
		$.ajax({
			...
			success: function(data){
				...
				if($.trim(search_txt) == "Print"){
					...
					html +='<div width="100%"  style="text-align:center"><img src="'+employee_import_url+'/images/logo.png" width="80"/></div><h2 style="text-align:center">Shastho Shikkha Foundation</h2><h4 style="text-align:center">Employee Information Report</h4><table width="100%"><tr><th width="60%" style="text-align:left"><small>'+serach_areas+'</small></th><th width="40%"  style="text-align:right"><small>Printed By: '+user_name+', Date:'+todate+'</small></th></tr></table>';
					
					if(!jQuery.isEmptyObject(data.records)){
						html +='<table width="100%" border="1px" style="margin-top:10px;border-collapse:collapse"><thead><tr><th style="text-align:left">ID</th><th style="text-align:left">Name</th><th style="text-align:left">Designation</th><th style="text-align:center">Health Card</th><th style="text-align:center">Contact No</th><th style="text-align:left">Status</th></tr></thead><tbody>';
					...
					if(!jQuery.isEmptyObject(records_array)){
						...
						var colums_array=["photo*image*"+project_url,"emp_id*identifier", "full_name","designation_name","health_card_no","contact_no*center"];
