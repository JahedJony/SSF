				...
				<div class="row advance_search_div alert alert-warning">
					<div class="row">
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<input id="health_card_no" name="health_card_no"  class="form-control input-sm" type="text" />
						</div>
...
$(document).ready(function () {	
	...
	load_bill_grid = function load_bill_grid(){		
		...
		if($.trim($('#health_card_no').val()) == ""){
			success_or_error_msg('#form_submit_error','danger',"Please Enter valid Health Card No","#health_card_no");			
		}
		else{
			$.ajax({
