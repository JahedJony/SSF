                    ...
                    <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        <?php
							...
							$news_info =  $dbClass->getResultList("select n.id, n.title, n.details, n.attachment, n.post_date, 
																...
																where `type`= 1 order by $condition id desc limit 5");	
					...
					<div class="sidebar-side col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<aside class="sidebar default-sidebar">                        
							...
							<div class="sidebar-widget popular-posts">
								<div class="sidebar-title"><h2>Upcoming Events</h2></div>
								...
								<?php
									...
									$event_info =  $dbClass->getResultList("select n.id,n.title, n.details, n.attachment, n.post_date, date_format(n.post_date, '%b') c_month, date_format(n.post_date, '%d') c_date, 
																		...
																		from web_notice n
																		join user_infos e on e.emp_id = n.posted_by
																		where `type`=2 order by id desc limit 2");	
									foreach ($event_info as $row){
										...
										if(empty($attachment)) 
											$attach_html = 	'<img src="images/default.jpg" alt="" />';
										$event_html .=
										'<article class="post">
											<figure class="post-thumb"><a href="events.php?events='.$row['id'].'">'.$attach_html.'</a></figure>
											<div class="text"><a href="events.php?events='.$row['id'].'">'.$title.'</a></div>
